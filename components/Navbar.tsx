...
const Navbar = () => {
  ...
  return (
    <div className="flex w-full justify-between lg:justify-center items-center h-[110px] px-6 md:p-6 navbar self-center scroll-smooth z-50 fixed mb-20 bg-black">
        <div className="flex lg:gap-12 justify-start lg:justify-center items-center w-full px-2">
          <Link href='/' className={cn(
                ...
                <span className="!cursor-pointe">
                  ...
                  /> */}
                  <p className="font-semibold tracking-wide text-2xl">A2G CONSTRUCTION</p>
              </span>
          </Link>
