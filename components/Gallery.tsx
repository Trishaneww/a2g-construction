  ...
  return (
    <div className="flex flex-col items-center pt-20 ">
        <div className="w-[85%] lg:w-[70%]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:flex flex-wrap gap-2 w-full mt-8">
                {gallery.slice(0,3).map((image, idx) => (
                    <div className="bg-white slate border-[1px] border-gray-200 flex flex-col h-[420px] xl:h-[540px] lg:w-[32%] shadow-lg" key={idx}>
