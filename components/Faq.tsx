...
const Faq = () => {
  return (
    <div className="flex flex-col justify-center items-center  mt-12 lg:mt-20 scroll-smooth py-24 pb-40">
        ...
        <div className="flex justify-center gap-6 lg:w-3/4 p-4 text-slate-950 text-base md:text-lg lg:text-xl">
            <Accordion type="single" collapsible className="flex flex-col gap-4 w-full xl:w-4/5">
                {faqData.map((accordion:any, idx:number) => (
                    <AccordionItem value={`item-${idx}`} className="p-4 rounded-2xl bg-white border-[1px] border-gray-200" key={idx}>
